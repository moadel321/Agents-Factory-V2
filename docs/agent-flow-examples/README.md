- [Agent Flow Patterns](#agent-flow-patterns)
  - [Overview](#overview)
  - [The Challenge: Flows vs States](#the-challenge-flows-vs-states)
    - [When Flowcharts Work Well](#when-flowcharts-work-well)
    - [When State Machines Shine](#when-state-machines-shine)
  - [The Examples](#the-examples)
    - [1. Simple Flow (`simple_flow.py`)](#1-simple-flow-simple_flowpy)
    - [2. Declarative Flow (`declarative_flow.py`)](#2-declarative-flow-declarative_flowpy)
    - [3. Multi-Stage Flow (`multi_stage_flow.py`)](#3-multi-stage-flow-multi_stage_flowpy)
